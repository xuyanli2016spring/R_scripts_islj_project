...
# make the terminal work under R, then enter command source("time_vs_solute_medium_alternative.R"), the script will start working 
# Input file: XXXX-XX-XX-XXXX-XXXX_mean_medium.csv
