...
# make the terminal work under R, then enter command source("time_vs_solute_medium_medium_1A.R"), the script will start working 
...
# > source("time_vs_solute_medium_update_1A.R")
# Please input the working directory: /Users/yanlixu/Desktop/experiment_data/bolus_in_2016_12/161220_161225/bolus_exp_data
...
# Please choose a number for every plot of the solute you would like to put legends, 1 for S, 2 for nMD, 3 for MitoDD, 4 for oAPAP, 5 for G, 6 for Marker, 7 for Repair, 8 for N: 2, 7
# You have 8 plots, please input how many rows and columns do you want to display the plots: 2, 2
...
time_vs_solute <- function()
{
  ...
  {
    exp_names[i] <- paste("medium_", conc[i], sep="")
