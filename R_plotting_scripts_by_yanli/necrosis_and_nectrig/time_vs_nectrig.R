...
# Based on your input, the bottom and upper limits of x-axis are 0 and 36000, Please input bottom and upper limits of y-axis to represent the range of nectrig: 0, 15000
...
time_vs_nec <- function()
{
  ...
  {
    plot(c(), c(), type = "l", main = "Time vs nectrig for different concentrations", xlab = "Time", ylab = "Nectrig", xlim = c(0, run_time), ylim = y_limits)
