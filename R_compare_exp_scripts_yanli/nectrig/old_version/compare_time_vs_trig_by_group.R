...
# make the terminal work under R, then enter command source("compare_time_vs_trig_by_group.R"), the script will start working 
...
# > source("compare_time_vs_trig_by_group.R")
...
# Please give a name to distinguish this group of exp, for example, liver infusion: liver_infusion
...
# Please give a name to distinguish this group of exp, for example, liver infusion: culture_infusion
# Enter 9 concentration values separated by comma: 5, 10, 15, 25, 35, 50, 75, 100, 125
# Please input 9 different colors to represent different concentrations, you may choose from these colors, black, blue, green, red, burlywood4, forestgreen, firebrick, blue4, purple, chocolate, cyan, gold, darkviolet, brown: black, blue, green, red, burlywood4, forestgreen, firebrick, blue4, purple
...
compare_time_vs_nectrig <- function()
{
  ...
  for(group_num in 1:num_of_groups)
  {
    ...
    # plot 
    plot(c(), c(), type = "l", main = paste("time vs nectrig of ", group_name, sep = ""), xlab = "time", ylab = "nectrig", xlim = c(0, run_time), ylim = y_limits)
