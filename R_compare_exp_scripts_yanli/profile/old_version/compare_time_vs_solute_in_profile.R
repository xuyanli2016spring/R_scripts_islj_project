# Name: Yanli Xu
# Date: Dec 19th, 2016
# Note: This script is used for compare the solute vs time in profiles of the same concentrations among different groups, the output is one plot for every concentration. 
# How to use this script: open terminal, cd to the directory of this script, enter command R will
# make the terminal work under R, then enter command source("compare_time_vs_solute_in_profile.R"), the script will start working 
# Input files: To compare n groups of experiments, every group of experiments has m "profile.csv" files in its directory: for example, if you want to 
# compare two groups of experiments, then you should put the two groups of experiments("profile.csv" files) in two different directories. 
